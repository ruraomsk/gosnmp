...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/ruraomsk/gosnmp)](https://pkg.go.dev/github.com/ruraomsk/gosnmp)
...
[gosnmp/gosnmp](https://github.com/ruraomsk/gosnmp).
...
```shell
go get github.com/ruraomsk/gosnmp
```

# Documentation

https://pkg.go.dev/github.com/ruraomsk/gosnmp
...
1. [fork this repo on the GitHub webpage](https://github.com/ruraomsk/gosnmp/fork)
1. `go get github.com/ruraomsk/gosnmp`
1. `cd $GOPATH/src/github.com/ruraomsk/gosnmp`
...
Please create an [issue](https://github.com/ruraomsk/gosnmp/issues) on
...
gocov test github.com/ruraomsk/gosnmp | gocov-html > gosnmp.html && firefox gosnmp.html &
```
